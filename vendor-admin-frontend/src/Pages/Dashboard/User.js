...
//       const response = await fetch("https://vendor-admin-p2ls.onrender.com/api/auth/getAllVendors", {
//         method: "GET",
...
//     try {
//       const token = localStorage.getItem("token");
//       const response = await fetch(`https://vendor-admin-p2ls.onrender.com/api/auth/vendors/${id}/deactivate`, {
//         method: "POST",
//         headers: { Authorization: `Bearer ${token}` },
//       });
...
//     try {
//       const token = localStorage.getItem("token");
//       const response = await fetch(`https://vendor-admin-p2ls.onrender.com/api/auth/vendors/${id}/activate`, {
//         method: "POST",
//         headers: { Authorization: `Bearer ${token}` },
//       });
